  ...
  if (success) {
    return (
      <div className="auth-page">
        <div className="auth-card glass animate-fade-in-up" style={{ textAlign: 'center' }}>
    ...
    <div className="auth-page">
      <div className="auth-card glass animate-fade-in-up">
        <div className="auth-card__header">
          ...
          <p className="auth-card__subtitle">Start mastering NCERT concepts today</p>
        </div>
        ...
        <button className="btn btn--outline btn--full auth-card__google" onClick={handleGoogle} disabled={loading}>
